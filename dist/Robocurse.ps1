...
function New-CompletionEmailBody {
    ...
    .OUTPUTS
        HTML string
    .EXAMPLE
        $html = New-CompletionEmailBody -Results $results -Status 'Success' -SessionId 'abc123'
    #>
    [CmdletBinding()]
    param(
        [Parameter(Mandatory)]
...
function Send-CompletionEmail {
    ...
    $htmlBody = New-CompletionEmailBody -Results $Results -Status $Status -SessionId $SessionId
